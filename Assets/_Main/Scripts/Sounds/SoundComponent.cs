...
namespace _Main.Scripts.Sounds
{
    ...
    public class SoundComponent : ManagedBehavior, IPoolable<SoundComponent>, ITrackedAudio, IUpdatable
    {
        private class VolumeChanger
        {
            private class ChangeVolumeAction : IQueueAction
            {
                protected readonly SoundComponent Sound;
                ...
                public ChangeVolumeAction(SoundComponent sound, float targetVolume, float startVolume, FadeData fadeData)
                {
                    Sound = sound;
            ...
            public static void ChangeVolume(SoundComponent sound, float targetVolume, float startVolume, 
                FadeData fadeData, Action onStart = null, Action onEnd = null)
            {
                ...
                ActionManager.Add(actions, PriorityTick.High);
            }
