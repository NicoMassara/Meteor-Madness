...
Shader "BaseMeteor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv_TexCoord2_g120 = i.uv_texcoord * float2( 1,1 ) + float2( 0,0 );
			float2 break2_g119 =  (float2( -1,-1 ) + ( uv_TexCoord2_g120 - float2( 0,0 ) ) * ( float2( 1,1 ) - float2( -1,-1 ) ) / ( float2( 1,1 ) - float2( 0,0 ) ) );
			float temp_output_5_0_g119 = ( ( break2_g119.x * break2_g119.x ) + ( break2_g119.y * break2_g119.y ) );
			float Depth14_g119 = saturate( ( sqrt( saturate( ( 1.0 - temp_output_5_0_g119 ) ) ) * 2.0 ) );
			float4 Emission40 = saturate( ( float4( Surface67 , 0.0 ) * Depth14_g119 ) );
			o.Emission = Emission40.xyz;
			o.Alpha = 1;
			float2 uv_TexCoord2_g122 = i.uv_texcoord * float2( 1,1 ) + float2( 0,0 );
			float smoothstepResult3_g121 = smoothstep( 1.0 , 0.98 , length(  (float2( -1,-1 ) + ( uv_TexCoord2_g122 - float2( 0,0 ) ) * ( float2( 1,1 ) - float2( -1,-1 ) ) / ( float2( 1,1 ) - float2( 0,0 ) ) ) ));
			float Circular_Mask7_g121 = sqrt( ( 1.0 - pow( ( 1.0 - smoothstepResult3_g121 ) , 2.0 ) ) );
			float OpacityMask10 = Circular_Mask7_g121;
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;61;-1376,160;Inherit;True;Property;_MeteorTexture1;MeteorTexture;1;0;Create;True;0;0;0;False;0;False;-1;54c9e9baffb09864a83d438f96841dfd;2dc229ee75747054188f795698b9d01c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;85;-1120,-288;Inherit;False;DepthSphere;-1;;118;3f6e013e4ff1a7d4ca2921bb52396135;0;1;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;86;-1280,576;Inherit;False;UV_CircularMask;-1;;121;28af572f72fc00741ad2033d2531b438;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;419.6417,-75.89265;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;0;Unlit;BaseMeteor;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Geometry;All;12;all;True;True;True;True;0;False;;True;1;False;;255;False;;255;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A5B0953113E0B720C39FE4F222DEC41BDCBEB2C0