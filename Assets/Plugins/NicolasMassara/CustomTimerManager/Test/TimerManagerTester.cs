...
namespace NicolasMassara.CustomTimerManager.Tests
{
    ...
    public class TimerManagerTester : MonoBehaviour
    {
        ...
        public void RemoveTimer()
        {
            ...
            if (TimerManager.Remove(_id))
            {
                Debug.Log($"Timer Removed, Id: {_id.Id}");
            }
        ...
        public void PauseTimer()
        {
            ...
            if (TimerManager.Pause(_id))
            {
                Debug.Log($"Timer Paused, Id: {_id.Id}");
            }
        }
        ...
        public void ResumeTimer()
        {
            ...
            if (TimerManager.Resume(_id))
            {
                Debug.Log($"Timer Resume, Id: {_id.Id}");
            }
        }
    }
