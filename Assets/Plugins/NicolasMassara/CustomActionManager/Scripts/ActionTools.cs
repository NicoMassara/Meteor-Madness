...
namespace NicolasMassara.CustomActionManager
{
    ...
    public class ConditionalWrapperAction : IQueueAction
    {
        ...
        public ConditionalWrapperAction(IQueueAction inner, Func<bool> condition)
        {
        ...
        public void OnStart()
        {
            if (!_condition())
            {
                // Si la condición no se cumple, la acción termina inmediatamente
                CurrentStatus = ActionStatus.Success;
                return;
            }
        ...
        public ActionStatus OnUpdate(float deltaTime)
        {
            ...
            if (!_condition())
            {
                // Si la condición se vuelve falsa mientras se ejecuta
                _inner.OnInterrupt();
                CurrentStatus = ActionStatus.Failure; // O Success si querés ignorar
                return CurrentStatus;
            }
    ...
    {
        public readonly int FramesToWait;
        ...
        {
            _framesElapsed++;
            return _framesElapsed >= FramesToWait ? ActionStatus.Success : ActionStatus.Running;
        }
        ...
        public void OnInterrupt()
        {
            ...
            _framesElapsed = FramesToWait;
        }
        
        public IQueueAction Copy()
        {
            return new WaitFramesAction(FramesToWait);
        }
    }
    public class WaitSecondsAction : IQueueAction
    {
        public readonly float TimeToWait;
    ...
    public class WaitForExternalAction : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new WaitForExternalAction(_externalActionSetter);
        }
    }
    public class ConditionalAction : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new ConditionalAction(_condition);
        }
    }
    public class WaitSecondsWithCallBack : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new WaitSecondsWithCallBack(_wait.TimeToWait, _onComplete, _onInterrupt);
        }
    }
    public class WaitFramesWithCallBack : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new WaitFramesWithCallBack(_wait.FramesToWait, _onComplete, _onInterrupt);
        }
    }
    public class TimedUpdateAction : IQueueAction
    {
        ...
        // Constructor
        public TimedUpdateAction(Action<float> updateFunc, float duration)
        {
    ...
    public class InstantAction : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new InstantAction(_action);
        }
    }
    ...
    public class FuncAction<T> : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new FuncAction<T>(_actionFunc, _resultCallback);
        }
    }
    ...
    public class CoroutineAction : IQueueAction
    {
        ...
        public CoroutineAction(MonoBehaviour owner, Func<IEnumerator> coroutineFunc)
        {
            _owner = owner;
        ...
        public void OnStart()
        {
            ...
            // Inicia la coroutine
            _runningCoroutine = _owner.StartCoroutine(RunCoroutine());
        }

        private IEnumerator RunCoroutine()
        {
            yield return _coroutineFunc.Invoke(); // Ejecuta la coroutine
            _isFinished = true;
        }
        ...
        public IQueueAction Copy()
        {
            return new CoroutineAction(_owner, _coroutineFunc);
        }
    }
    ...
    public class AsyncQueueAction : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new AsyncQueueAction(_asyncAction);
        }
    }
    ...
    public class SetFloatAction : IQueueAction
    {
        ...
        public SetFloatAction(float value, Action<float> action)
        {
            _value = value;
            _action = action;
        }
    ...
    public class SetBoolAction : IQueueAction
    {
        ...
        public SetBoolAction(bool value, Action<bool> action)
        {
            _value = value;
            _action = action;
        }
        ...
        public IQueueAction Copy()
        {
            return new SetBoolAction(_value, _action);
        }
    }
    ...
    public class LogDebugAction : IQueueAction
    {
        ...
        public IQueueAction Copy()
        {
            return new LogDebugAction(_message);
        }
    }
